...
const $el = await _waitForElement(".top-bar");
  ...
  http.send();
  if (http.status != 404) {
    download_button_el_img_download = document.createElement('img');
    download_button_el_img_download.src = "/playback/presentation/2.3/static/media/download.png"
    
    download_button_el.appendChild(download_button_el_img_download);
    ...
    download_button_el_img_wait = document.createElement('img');
    download_button_el_img_wait.src = "/playback/presentation/2.3/static/media/wait.png"
    download_button_el_img_wait.setAttribute("title", "MP4 file is not ready yet! Reload page later!");
    download_button_el_img_wait.setAttribute("onclick", "alert('MP4 file is not ready yet! Reload page later!');");
